  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Chỉnh Sửa Chức Vụ</h5>
            <!-- Multi Columns Form -->
                      ...
                      <?php foreach ($roles as $role) : ?>
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                          ...
                          <label class="form-check form-switch ">
                            <input type="checkbox" <?php foreach ($group_role as $group) {
                                                      if ($group->role_id == $role['id']) {
                                                        echo 'checked="checked"';
                                                      }
                                                    } ?> name="roles[]" class="checkItem form-check-input checkItem" value="<?= $role['id'] ?>">
