  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Thêm Khach</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form onsubmit="return addUser()" class="row g-3" method="post" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                <label for="inputEmail5" class="form-label">Số Điện Thoại: <span style="color:red" id="errorsEmail">(*)</span></label>
                <input type="number" name='sdt' class="form-control" id="email">
              </div>
              <!-- <div class="col-md-6">
              ...
              <!-- <div class="col-md-4">
                ...
                <select id="inputState" name="group" class="form-select">
                  ...
                  <?php foreach ($phongs as $phong) : ?>
                    <option value="<?= $phong->id ?>"><?= $phong->name ?></option>
                  <?php endforeach ?>
                </select>
              </div>
              <div class="col-md-4">
